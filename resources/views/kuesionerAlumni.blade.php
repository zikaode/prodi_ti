            ...
            <div class="row d-flex align-items-center justify-content-center">
                <div class="about-content col-lg-12">
                    ...
                    <p class="text-white link-nav"><a href="{{ route('static.index') }}">Home </a> <span
                            class="lnr lnr-arrow-right"></span><a href="{{ route('static.kuesionerAlumni') }}">Kuesioner
                            Alumni</a>
                    </p>
                </div>
            </div>
                ...
                <div class="col-lg-8 posts-list">
                    <div class="single-post row">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <h3 class="mt-20 mb-20">KUESIONER ALUMNI</h3>
                            <iframe
                                src="https://docs.google.com/forms/u/0/d/e/1FAIpQLSfQIaQhskQq01Eehw1x9K0nAYcCX4zTK86W5J8wW-PB3wnyCw/formResponse?embedded=true"
